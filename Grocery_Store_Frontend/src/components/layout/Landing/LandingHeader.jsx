          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              {!isMenuOpen && (
                <Link
                  to="/auth/login"
                  className="hidden md:inline-flex gap-1 items-center bg-white text-green-700 font-semibold px-5 py-2 rounded-xl shadow hover:bg-green-100 transition-all duration-300"
                >
